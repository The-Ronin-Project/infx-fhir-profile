...
* participant[0].actor.reference = "Patient/roninPatient01Test"
* participant[0].status = #accepted
* participant[1].actor = Reference(roninPractitioner01Test)
* participant[1].actor.display = "Dr. Harvey Feest"
* participant[1].actor.reference = "Practitioner/roninPractitioner01Test"
...
* participant[0].actor.reference = "Patient/roninPatient02Test"
* participant[0].status = #accepted
* participant[1].actor = Reference(roninPractitioner02Test)
* participant[1].actor.display = "Dr. Alfred Grey"
* participant[1].actor.reference = "Practitioner/roninPractitioner02Test"
* participant[1].status = #accepted
...
* participant[0].actor.reference = "Patient/roninPatient03Test"
* participant[0].status = #accepted
* participant[1].actor = Reference(roninPractitioner02Test)
* participant[1].actor.display = "Dr. Alfred Grey"
* participant[1].actor.reference = "Practitioner/roninPractitioner02Test"
...
* participant[0].actor.reference = "Patient/roninPatient04Test"
* participant[0].status = #accepted
* participant[1].actor = Reference(roninPractitioner04Test)
* participant[1].actor.display = "Dr. Wendyline Kebbe"
* participant[1].actor.reference = "Practitioner/roninPractitioner04Test"
* participant[1].status = #accepted
...
* participant[0].actor.reference = "Patient/roninPatient05Test"
* participant[0].status = #accepted
* participant[1].actor = Reference(roninPractitioner05Test)
* participant[1].actor.display = "Dr. Brian Allergy"
* participant[1].actor.reference = "Practitioner/roninPractitioner05Test"
* participant[1].status = #accepted
* appointmentType = AppmtType#ROUTINE "Routine appointment - default if not valued"
